...
@pytest.mark.parametrize(
    "value, expected",
    [("Visa 1234123412341234", "Visa 1234 12** **** 1234"), ("Qiwi 484698468468464684681234", "Qiwi **1234")],
)
...
@pytest.mark.parametrize(
    "time, expected", [("2025-01-01T00:00:00.000000", "01.01.2025"), ("2026-12-31T00:00:00.000000", "31.12.2026")]
)
